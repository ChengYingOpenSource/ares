...
public class Ares2MockHttpQuery extends BaseQuery implements Serializable {
    private static final long serialVersionUID = 1L;

    public Ares2MockHttpQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table ares2_mock_http
     */
