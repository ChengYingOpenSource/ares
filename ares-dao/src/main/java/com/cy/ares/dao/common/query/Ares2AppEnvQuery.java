...
public class Ares2AppEnvQuery extends BaseQuery implements Serializable {
    private static final long serialVersionUID = 1L;

    public Ares2AppEnvQuery() {
        super();
    }
    ...
    /**
     * This class corresponds to the database table ares2_app_env
     */
